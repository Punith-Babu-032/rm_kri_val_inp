		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Risk Management KRI Value Input ",
									"targetURL": "#rmkrivalinput-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rmkrivalinput-display": {
								"semanticObject": "rmkrivalinput",
								"action": "display",
								"description": "Risk Management KRI Value Input ",
								"title": "Risk Management KRI Value Input ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rmkrivalinput",
									"url": sap.ui.require.toUrl("rmkrivalinput")
								}
							}
						}
					}
